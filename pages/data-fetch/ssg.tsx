...
/**
 *
 * @param {StaticSideGenerationProps} StaticSideGenerationProps interface of the static side props
 * @param {StaticSideGenerationProps.envState} StaticSideGenerationProps.envState
 * fetched data of the envirment properties
 * @param {StaticSideGenerationProps.nextPublicState} StaticSideGenerationProps.nextPublicState
 * fetched data of the next envirment properties
 * @returns {ReactElement} React elements of server side page
 */
export default function StaticSideGeneration({
  envState,
  nextPublicState,
}: StaticSideGenerationProps): ReactElement {
  return (
    <div>
      {envState.length > 0 && (
        <div>
 ...
 */
export async function getStaticProps(): Promise<GetServerSideProps> {
